...
en_phone = '$en_phone', en_email = '$en_email', village = '$village', district = '$district', provice = '$provice', position = '$position', responsible='$responsible', salary='$salary', en_image = '$new_image_name' WHERE en_id ='$en_id'";
