...
<?php
                            ...
                            $nquery_1 = mysqli_query($conn, "SELECT * from  type_product WHERE type_id  GROUP BY type_id DESC");
...
<br>
	<div style="border-raduis:10px; height: 100%;">
		...
		<center>
            <label style="font-family:'noto Sans Lao'; font-weight:bold; font-size:20px">ສະຫຼຸບລາຍການປະເພດສີນຄ້າທັງໝົດ</label>
		</center>
		<br>
				...
				<tbody>
									<?php foreach ($nquery_1 as $rs) { ?>
                                        ...
                                        <td>
											...
											<td><img src="./image/<?= $rs["type_img"] ?>" width="80px" height="60px"> </td>
											<td>
												<?= $rs['type_name']?>
											</td>
										</tr>
...
$mpdf->WriteHTML($html);
$mpdf->Output('report_pdf/Report.pdf');
ob_end_flush();
...
<div class="button_print my-12">
	<a href="report_pdf/Report.pdf"><button class="btn btn-primary my-12 button_print_1">ລາຍງານເປັນ PDF</button> </a>
</div>
<br>