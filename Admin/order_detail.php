...
<center>
	<h4>ລາຍການສັ່ງຊື້ສີນຄ້າ<br>
		...
		<h6>ວ/ດ/ປ : <?php echo date('d/m/y',strtotime($rowmember['order_date'])); ?></h6>
		<h6>ຜູ້ທຳລາຍການ : <?php echo $rowmember['mem_name']; ?> <br />ສະຖານະ :
			<?php include('mystatus.php');?></h6>
	</h4>
</center>
...
<table border="0" align="center" class="table table-hover table-bordered table-striped">
	...
	?>
		...
		<td align='right' colspan='2'>
			<b><?php echo number_format($total,0);?> Kip</b>
			<br>
			<b><?php echo number_format($rowmember['pay_amount2'],0);?> Kip</b>
			<br>
			<b><?php echo number_format($pay_amount3,0);?> Kip</b>
		</td>
	</tr>
</table>
<br>
