					...
					<div class="col">
						...
						<div class="container text-center">
							<div class="row ">
								...
								<div class="col" align="end">
									<form class="form-group my-3" action = "Report_enployee_admin.php" method="GET">
										<div class="row">
											<div class="col-12">
					<a href="Report_enployee_admin.php?en_id=<?php echo $rs['en_id']; ?>&act=view" target="_blank"
