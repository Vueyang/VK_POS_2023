<!DOCTYPE html>
<html>
<?php include('Admin/connetdb.php')?>
...
<head>
	...
	<link rel="icon" type="" href="Admin/image/vk.jpg" />
	<!-- Font Awesome -->
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
	<!-- Ionicons -->
	<link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
	<!-- icheck bootstrap -->
	<link rel="stylesheet" href="Admin/assets/icheck-bootstrap.min.css">
	<!-- Theme style -->
	<link rel="stylesheet" href="Admin/assets/adminlte.min.css">
	<link rel="stylesheet" href="Admin/fonts/NotoSansLao-VariableFont_wdth,wght.ttf">
...
.hold-transition {
	...
	background-image: url("Admin/image/picture1.jpg");
	...
	<div class="login-box">
		...
		<div class="card">
			<div class="card-body login-card-body">
				<center><img width="150px" src="Admin/image/vk.jpg"><br>
					<h3><b>VK POS </b>2023</h3> <br>
					<h4>Please Login</h4>
				</center><br>
