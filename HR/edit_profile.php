...
$query_member = "SELECT * FROM tbl_member m, tbl_employee e WHERE m.en_id = e.en_id AND m.mem_id = '$mem_id' ";
...
<section class="content" style="padding:20px 20px">
	<div class="card card-gray">
		...
		<div class="modal-body">
			...
			<form action="edit_mamber.php?id=<?= $row['mem_id']; ?>" method="POST" enctype="multipart/form-data">
				...
				<!-- Modal footer -->
				<div class="button mb-4 mt-4 d-flex justify-content-between">
						<a class=" btn btn-danger" href="Dashboard.php" role="button">ຍົກເລີກ</a>
